...
from ..main import (
    SKIP_VALUE, LOGGER, TypeHavoc as BaseTypeHavoc, GenFactory as BaseFactory,
    Havoc as BaseHavoc, partial, faker)
...
class TypeHavoc(BaseTypeHavoc):

    """ TypeHavoc for SQLAlchemy. """

    factory = GenFactory

    def __init__(self, cls, **params):
        """ Init TypeHavoc and save the mapper. """
        super(TypeHavoc, self).__init__(cls, **params)
    ...
    def get_value(self, field_name, field_value):
        ...
        return super(TypeHavoc, self).get_value(field_name, field_value)
    ...
    def make_fabric(self, column, field_name=None, fake=False, kwargs=None): # noqa
        ...
        if stype is str:
            fab = super(TypeHavoc, self).make_fabric(
        ...
        return super(TypeHavoc, self).make_fabric(
            stype, field_name=field_name, fake=fake, kwargs=kwargs)
...
class Havoc(BaseHavoc):

    """ Integration with SQLAlchemy. """

    type_mixer_cls = TypeHavoc

    def __init__(self, session=None, commit=True, **params):
        """Initialize the SQLAlchemy Havoc.
        ...
        """
        super(Havoc, self).__init__(**params)
